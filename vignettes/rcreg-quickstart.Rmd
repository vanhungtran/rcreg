...
cat("  AIC:", summ_int$aic, "\n")
cat("  BIC:", summ_int$bic, "\n\n")

cat("Random Intercept + Slope Model:\n")
cat("  AIC:", summ_both$aic, "\n")
cat("  BIC:", summ_both$bic, "\n")

# Lower AIC/BIC indicates better fit
if (summ_both$aic < summ_int$aic) {
  cat("\nThe random intercept + slope model has better fit (lower AIC).\n")
}
```
...
5. **Utility functions** for common preprocessing tasks
